...
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`usuario` (
  ...
  `dit_nascimento` DATE NOT NULL,
  `dit_criacao` DATETIME NOT NULL DEFAULT current_timestamp,
  `dit_filiacao` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `hellow_eventos`.`forneceor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`forneceor` (
  `id` SMALLINT NOT NULL,
  `nome` VARCHAR(50) NOT NULL,
  ...
  INDEX `fk_forneceor_endereco1_idx` (`endereco_id` ASC) ,
  INDEX `fk_forneceor_tipo1_idx` (`tipo_id` ASC) ,
  CONSTRAINT `fk_forneceor_endereco1`
    FOREIGN KEY (`endereco_id`)
    REFERENCES `hellow_eventos`.`endereco` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_forneceor_tipo1`
    FOREIGN KEY (`tipo_id`)
    REFERENCES `hellow_eventos`.`tipo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`cliente` (
  ...
  INDEX `fk_cliente_evento1_idx` (`evento_id` ASC) ,
  CONSTRAINT `fk_cliente_endereco1`
    FOREIGN KEY (`endereco_id`)
    REFERENCES `hellow_eventos`.`endereco` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cliente_evento1`
    FOREIGN KEY (`evento_id`)
    REFERENCES `hellow_eventos`.`evento` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`fk_ingresso_cliente` (
  ...
  INDEX `fk_ingresso_has_cliente1_cliente1_idx` (`cliente_id` ASC) ,
  INDEX `fk_ingresso_has_cliente1_ingresso_idx` (`ingresso_id` ASC) ,
  CONSTRAINT `fk_ingresso_has_cliente1_ingresso`
    FOREIGN KEY (`ingresso_id`)
    REFERENCES `hellow_eventos`.`ingresso` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ingresso_has_cliente1_cliente1`
...
-- -----------------------------------------------------
-- Table `hellow_eventos`.`fk_fornecedor_envento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`fk_fornecedor_envento` (
  `forneceor_id` SMALLINT NOT NULL,
  `evento_id` SMALLINT NOT NULL,
  PRIMARY KEY (`forneceor_id`, `evento_id`),
  INDEX `fk_forneceor_has_evento_evento1_idx` (`evento_id` ASC) ,
  INDEX `fk_forneceor_has_evento_forneceor1_idx` (`forneceor_id` ASC) ,
  CONSTRAINT `fk_forneceor_has_evento_forneceor1`
    FOREIGN KEY (`forneceor_id`)
    REFERENCES `hellow_eventos`.`forneceor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_forneceor_has_evento_evento1`
    FOREIGN KEY (`evento_id`)
    REFERENCES `hellow_eventos`.`evento` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
